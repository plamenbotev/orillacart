                                    ...
                                    <tr>
                                        <td valign="top">
                                            <p style="font-size:12px; line-height:16px; margin:0;">
                                                <?php _e("Thank you for your order!", "com_shop"); ?>
                                                <?php _e("If you had troubles with payment process you can", "com_shop"); ?> <a href="<?php echo Route::get("component=shop&con=cart&task=process_payment&order_id=" . $this->order['ID'] . "&order_key=" . $this->order['post_password']); ?>"><?php _e("retry the payment", "com_shop"); ?></a> <?php _e("or", "com_shop"); ?> <a href="<?php echo Route::get("component=shop&con=cart&task=cancel_order&order_id=" . $this->order['ID'] . "&order_key=" . $this->order['post_password']); ?>"><?php _e("cancel the order.", "com_shop"); ?></a>
                                            </p>
