                                        ...
                                        <td valign="top">
                                            <p style="font-size:12px; line-height:16px; margin:0;">
                                                <?php if ($this->status == 'failed') { ?>
                                                    <?php _e("Your payment for that order has failed.", "com_shop"); ?>
                                                <?php } else if ($this->status == 'completed') { ?>
                                                    <?php _e("Your order is marked as completed and is awaiting processing and shipment. You will receive updates via email.", "com_shop"); ?>
                                                <?php } ?>
                                            </p>
