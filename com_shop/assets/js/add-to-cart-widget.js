jQuery(document).ready(function () {
	...
	jQuery('a.buy_button').bind('click', function (e) {
		...
		jQuery.ajax({
			type : 'get',
			url : shop_helper.ajaxurl + '?action=framework-ajax-front&component=shop&con=cart&task=add_to_cart&id=' + id,
	...
	jQuery('form#product_addtocart_form').validate({
		...
		submitHandler : function (form) {
			...
			var url = shop_helper.ajaxurl + '?action=framework-ajax-front&component=shop&con=cart&task=add_to_cart_custom';
