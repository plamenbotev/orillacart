...
function new_attribute(){
	...
	document.getElementById('attributes').appendChild(div);
	 jQuery("div#attributes").sortable({"axis":"y","items":"div.attributeContainer","containment":"parent","cursor":"move","cancel":':input,button,a'});
...
total_props++;
 jQuery(parent).sortable({"axis":"y","items":"div.subPropertyContainer","containment":"parent","cursor":"move","cancel":':input,button,a'});
...
jQuery("div#attributes").sortable({"axis":"y","items":"div.attributeContainer","containment":"parent","cursor":"move","cancel":':input,button,a'});  
  ...
  jQuery("div.attributeProps").sortable({"axis":"y","items":"div.subPropertyContainer","containment":"parent","cursor":"move","cancel":':input,button,a'});
...
if(dom.id == "attributes") selector =".aordering";
    else if(jQuery(dom).hasClass("attributeProps")) selector =".pordering";
   

   jQuery(selector,dom).each(function(i,el){ jQuery(el).val(i); });
