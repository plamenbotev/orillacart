<div class="com_shop">
    <form name='adminForm' method='post' enctype="multipart/form-data" action='<?php echo admin_url('admin.php?page=component_com_shop-attributes'); ?>'>
        ...
        <fieldset class="panelform">
            <ul class="adminformlist">
                <li>
                    ...
                    <input type="text" name="attribute_set_name" id="attribute_set_name" value="<?php echo strings::stripAndEncode($this->set->attribute_set_name); ?>" />
                </li>
                <li>
        ...
        <span id='stock_rooms' style='display:none;'>
            <select id='stock_room_selector'>
                ...
                <?php while ($sr = $this->stock_rooms->nextObject()) { ?>
                    ...
                    <option value='<?php echo $sr->id; ?>' > <?php echo strings::stripAndEncode($sr->name); ?></option>
        ...
        <div id='attributes'>
            ...
            <?php
            for ($c = 0; $c < count($this->set->_data); $c++) {
                ...
                <div class="attributeContainer" id="att-<?php echo $c; ?>">
                    ...
                    <div class='boxHeader'>
                        ...
                        <input type='text' value='<?php echo strings::stripAndEncode($att->attribute_name); ?>' name='title[<?php echo $c; ?>][name]' />
                        <input type='hidden' class='aordering' name='title[<?php echo $c; ?>][ordering]' size='3' value='<?php echo $att->ordering; ?>' >
                        <button class="btn btn-small" onclick="addproperty(jQuery('.attributeProps',this.parentNode.parentNode)[0],<?php echo $c; ?>); return false;"><?php _e('Enter sub attribute', 'com_shop'); ?></button>
                                    ...
                                    $prop = $this->set->_data[$c]['property'][$cp];
                                        ...
                                        <div class="subPropertyContainer">
                                            ...
                                            <div class='boxHeader'>
                                                ...
                                                <strong><?php _e('Title:', 'com_shop'); ?></strong>
                                                <input type='text' size='10' value="<?php echo strings::stripAndEncode($prop->property_name); ?>" name='property[<?php echo $c; ?>][value][]' />
