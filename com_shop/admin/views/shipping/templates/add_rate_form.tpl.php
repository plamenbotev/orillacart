<div class="com_shop">
                ...
                <li>
                    ...
                    <select onchange="jsShopAdminHelper.loadStatesByCountries(this,'changestate')" size="5" multiple="multiple" id="shipping_rate_country" name="shipping_rate_country[]">
                        ...
                        <?php foreach ((array) $this->countries as $o) { ?>
                            <option value="<?php echo $o->country_2_code; ?>" <?php echo (in_array($o->country_2_code, $this->row->shipping_rate_country)) ? "selected='selected'" : ""; ?> ><?php echo strings::stripAndEncode($o->country_name); ?></option>
                        <?php } ?>
                    </select>
                </li>
                <li>
                    ...
                    <div id="changestate">
                        <select multiple="multiple" id="shipping_rate_state" name="shipping_rate_state[]">
                            <?php foreach ((array) $this->states as $o) { ?>
                                <option value="<?php echo $o->state_2_code; ?>" <?php echo (in_array($o->state_2_code, $this->row->shipping_rate_state)) ? "selected='selected'" : ""; ?> ><?php echo strings::stripAndEncode($o->state_name); ?></option>
                            <?php } ?>
                        </select>
                    </div>
                </li>
    ...
    <input type="hidden" name="carrier" value="<?php echo $this->row->carrier | Request::getInt('cid', null); ?>" />
</form>
</div>