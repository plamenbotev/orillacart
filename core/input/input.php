 ...
 */
class Input implements IteratorAggregate, ArrayAccess, Serializable, Countable {
    ...
    public function __construct($source = null, array $options = array()) {
        ...
        if (is_null($source)) {
            $this->data = stripslashes_deep($_REQUEST);
        } else {
            $this->data = $source;
        }
    ...
    public function __get($name) {
        ...
        if (isset($GLOBALS[$superGlobal])) {
            $this->inputs[$name] = new Input(stripslashes_deep($GLOBALS[$superGlobal]), $this->options);
    ...
    public function set() {
        ...
        throw new InvalidArgumentException("Invalid arguments for Input::set. You need to provide array \$data or string \$key, mixed \$data");
    }
